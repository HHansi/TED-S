...
def encode(df, label_column='label'):
    ...
    # df[label_column].replace('negative', label_mapping['negative'], inplace=True)
    # df[label_column].replace('neutral', label_mapping['neutral'], inplace=True)
    # df[label_column].replace('positive', label_mapping['positive'], inplace=True)
    ...
    # df.loc[df[label_column] == 'neutral'] = label_mapping['neutral']
    # df.loc[df[label_column] == 'positive'] = label_mapping['positive']
